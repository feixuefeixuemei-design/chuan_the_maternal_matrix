...
function autoFix(sentence) {
    ...
    res = res.replace(/\bof the the\b/gi, 'of the');
    res = res.replace(/\bin the the\b/gi, 'in the');
    // ----------------------------------------------
...
function generatePoemLine(word) {
    ...
    const structuralTemplates = [
        ...
        // --- 进一步扩充 ---
        () => `A ritual for ${concept}.`,
        () => `From the source: ${concept}.`,
        () => `Between the heart and ${concept}.`,
        () => `Tracing the edges of ${concept}.`,
        () => `Not lost, but held: ${concept}.`,
        () => `Everywhere, the scent of ${concept}.`,
        () => `${pick(elements.setting)}, ${concept} remains.`,
        () => `To touch ${concept} is to find home.`,
        () => `Before the first word, there was ${concept}.`,
        () => `A slow return to ${concept}.`,
        () => `In every breath, ${concept}.`,
        () => `${concept}—this is the mending.`,
        () => `Listen: ${concept}; ${pick(elements.action)}`,
        () => `The architecture of ${concept}.`,
        () => `Wrapped in silk, defined by ${concept}.`,
        () => `A brief history of ${concept}.`,
        () => `Beyond the heavy dark: ${concept}.`,
        () => `Everything leans toward ${concept}.`,
        () => `The materiality of ${concept}.`,
        () => `A physical trace: ${concept}.`,
        () => `In the name of ${concept}, ${pick(elements.action)}`,
        () => `An inventory of ${concept}.`,
        () => `The soft mechanics of ${concept}.`,
        () => `What is left but ${concept}?`, 
        () => `Beneath the surface of ${concept}.`,
        () => `The collective memory of ${concept}.`,
        () => `Through the lens of ${concept}.`,
        () => `${concept}—an ongoing ritual.`
    ];
